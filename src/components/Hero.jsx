  ...
  return (
    <>
      ...
      >
        ...
        {/* 1ª CAMADA: Cenário - bg-cover é ideal aqui */}
        <div className="absolute inset-0 z-0 bg-[url('/back-01.png')] bg-cover bg-center bg-no-repeat opacity-100"></div>

        {/* 2ª CAMADA: O Advogado - AJUSTADO PARA RESPONSIVIDADE */}
        <div className="absolute inset-0 z-10 
          bg-[url('/back02.png')] 
          bg-no-repeat pointer-events-none 
          /* Mobile: imagem menor e centralizada embaixo */
          bg-[length:90%] bg-bottom 
          /* Tablet: um pouco maior */
          sm:bg-[length:70%] 
          /* Desktop: volta para a direita e ML-40 */
          md:bg-contain md:bg-right-bottom md:ml-40 opacity-100"
        ></div>

        {/* GRADIENTE DE CONTRASTE: Para garantir que o texto seja lido no mobile */}
        <div className="absolute inset-0 z-15 bg-gradient-to-t from-black/80 via-black/20 to-transparent md:hidden"></div>
        ...
        <div className="w-full max-w-6xl mx-auto px-4 md:px-6 z-20 md:mt-24 mb-10 md:mb-0">
          <div className="max-w-2xl text-center md:text-left">
            ...
            <p className="font-sans-lux text-white text-sm md:text-lg leading-relaxed mb-8 md:mb-10 max-w-lg mx-auto md:mx-0 font-light drop-shadow-[0_2px_8px_rgba(0,0,0,1)] opacity-90">
